...
public class ControladorPartida {
	...
	// Devuelve true si todo está preparado y ataca al pokemon defensor con el ataque del atacante
	// y resetea todos los atacantes y defensores, si todos los pokemons estan derrotados,
	// cambia el estado del jugador a derrotado y si solo queda 1 jugador lo pone como ganador, para la partida
